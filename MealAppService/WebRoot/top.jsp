		...
		<div style="width: 960px; margin: 0 auto">
			...
			<div class="menu">
				<ul>
					<li>
						<a
							href="/MealAppService/servlet/GridServlet?Action=getlist&currentpage=0"><b>菜品管理</b>
						</a>
						<a
						...
						<a
							href="/MealAppService/servlet/GridServlet?Action=getbusinesslist&currentpage=0"><b>商家管理</b>
						</a>
						<a style="float:right;"
